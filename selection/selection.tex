...
\begin{center}
\subfigure[]{
  \includegraphics[width=.85\textwidth]{./selection/figures/strategies-one-winner.pdf}
  \label{f:ls-one-winner}
} 
\subfigure[]{
  \includegraphics[width=.85\textwidth]{./selection/figures/strategies-competition.pdf}
