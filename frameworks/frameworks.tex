...
An example network for an utterance like ``the block'' is shown in
...
block'']{\subref{f:context} a hypothetical context \subref{f:network}
...
\subfigure[]{
    \includegraphics[width=\textwidth]{./frameworks/figures/evaluation.pdf}
