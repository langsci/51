...
\centering
\subfigure[]{
  \includegraphics[width=.40\textwidth]{./achromatic/figures/semantics-achromatic.pdf}
  \label{f:ams-semantics-basic}
}
\subfigure[]{
  \includegraphics[width=.40\textwidth]{./achromatic/figures/semantics-basic-categories.pdf}
  \label{f:ams-semantics-basic-categories}
}
\subfigure[]{
  \includegraphics[width=.65\textwidth]{./achromatic/figures/semantics-achromatic-transformed.pdf}
...
The semantics of the \emph{basic modification strategy} can be
