...
operators for that strategy. The \emph{adoption operator}\is{adoption operator|see{learning operators}}\is{learning operators} specifies how language users can pick up items of the language
...
evaluated in an \emph{acquisition experiment}\is{acquisition experiment} 
in which one agent
