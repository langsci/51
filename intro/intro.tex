...
Figure \ref{f:category-combination}. The colours between \textit{\v
...
\begin{figure}[htpb]
  ...
  \caption[Location of modified basic colour foci in Russian]{Location
    ...
    circle), \textit{jarko-} (`bright', sun), \textit{svetlo-} (`light', open circle) and ``bledno-'' (`pale', dashed circle). Figure
...
which they try to achieve \emph{communicative goals}\is{communicative goal}, like for example drawing the
...
Part \ref{s:language-strats} of this book focusses on the
