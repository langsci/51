...
different \emph{language strategies}\is{language strategy} to
...
category. A \emph{language system}\is{language system} consists of
...
categories. Each colour category has a \emph{focal colour}\is{focal
