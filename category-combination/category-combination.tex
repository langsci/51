...
\centering
\subfigure[]{
  \includegraphics[width=.65\textwidth]{./category-combination/figures/semantics-before-transformation.pdf}
  \label{f:ccs-semantics-before-transformation}
}
\subfigure[]{
  \includegraphics[width=.65\textwidth]{./category-combination/figures/semantics-transformed.pdf}
...
The linguistic structure for ``zel\"eno-\v z\"eltyj'' (green-yellow)
...
\begin{table}[htpb]
  ...
  \begin{tabular}{lll}
    ...
    (f) & ``zel\"enyj'' & ``zelenyj'' \\
  \end{tabular}
  \caption[Naming benchmark for Russian colour compounds]{Naming benchmark for Russian colour compounds. Five out of six samples are named correctly. The one sample that can not be named is wrongly categorised as ``zeltyj'' during the first categorisation process based on colour.}
